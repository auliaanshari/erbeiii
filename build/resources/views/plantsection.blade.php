                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table id="tplantsection" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            <th>Plant Section Code</th>
                                            <th>Plant Section Name</th>
                                            <th>Action</th>
...
<script type="text/javascript">
            function loadData() {
                $('#tplantsection').dataTable({
                    "ajax": "{{ url('/plantsection/data') }}",
                    "columns": [
                        { "data": "plant_section_code" },
                        { "data": "plant_section_name"},
                        {
                            data: 'equipment_code',
                            sClass: 'text-center',
